---
title: "Agent Testing"
description: "Learn how Janus automates evaluation of your AI agents"
---

## How It Works

### 1. **How Evaluations Work**
Janus synthetically generates realistic tasks from your company data, context, and seed examples. Whether your agent handles chat, voice, workflows, or multimodal interactions, Janus creates diverse test scenarios tailored to your domain:

```python
await janus.run_simulations(
    num_simulations=10,  # Run 10 tests
    max_turns=5,         # Each test has up to 5 turns
...
>
  Learn how to configure eval templates and personas in the webapp
</Card>
...
# Test through automated evaluation
...
Before running evaluations, you need to set up your testing environment in the Janus webapp:

1. **Create Test Cases**: Provide 5-10 examples of real test sets/queries. This will serve as the basis for creating evaluation runs.
2. **Set Up Rule Sets**: Configure evaluation criteria and compliance rules
3. **Create Eval Templates**: Design personas and conversation parameters
...
<Card
  ...
  href="/concepts/webapp-setup"
>
  Learn how to configure test cases, rules, and eval templates
</Card>
...
>
  Check your evaluation results in the Janus dashboard
</Card>

## Best Practices

<Tip>
- Start with 10-20 tests for initial testing
- Increase test count for comprehensive evaluation
- Use custom context to match your specific use case
- Monitor results in the Janus dashboard for detailed insights
</Tip>

<Warning>
Running many tests can be resource-intensive. Monitor your API usage and system resources.
</Warning>
...
**Solution:** Export evaluation data as JSONL and use it for fine-tuning, RLHF, or custom training pipelines

**What you get:**
- Full conversation trajectories with rule compliance signals
- Edge case examples for model improvement
- Domain-specific evaluation datasets in JSONL format
...
**Solution:** Run evaluations after every code change to catch regressions

**How it works:**
- Run 100+ tests after each deployment
