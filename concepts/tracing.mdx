...
Rule violations appear in the Janus dashboard alongside your traces:
1. **Go to Results** at [app.withjanus.com](https://app.withjanus.com)
2. **Select a conversation** to view detailed results
3. **Click on the Traces tab** to see function and tool traces
4. **Check rule compliance** for each traced operation
