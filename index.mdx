---
title: "Janus Docs"
description: "Automated evaluation infrastructure for AI agents."
---

## Evaluate AI Agents in Days, not Months

Automated evaluation infrastructure for AI agents. Generate thousands of tests, run specialized judges, know exactly where your agents break, improve, and retest.

What you get:

- Auto-generate 10,000+ tasks for your agent in hours (zero annotation)

- Evaluate chat agents, voice agents, workflows, and multimodal systems with specialized judges

- Export evaluation data in JSONL for fine-tuning, RLHF, or custom analysis
...
<Columns cols={2}>
  <Card
    title="Automated Eval Runs"
    icon="flask"
    href="/concepts/agent-testing"
  >
    Evaluate your agents with 10,000+ tests from 10-15 seed examples, each testing different personalities, intents, and edge cases.
  </Card>
  <Card
  ...
  <Card
    title="Function Tracing & Observability"
    icon="route"
    href="/concepts/tracing"
  >
    Trace every function call, API request, and tool invocation your agent makes.
  </Card>
  <Card
...
Run automated evaluation runs with different personas to test your AI agent across various tasks.
...
<Step title="Get an API Key">
  Contact the Janus team at [team@withjanus.com](mailto:team@withjanus.com) to get your API key and login credentials. We'll set up your eval pipeline with you and get you running tests in days.
